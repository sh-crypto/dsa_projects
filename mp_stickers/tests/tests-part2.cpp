...
TEST_CASE("StickerSheet::setStickerAtLayer() past the top layer", "[weight=5][part=2][timeout=30000]") {
  Image alma; alma.readFromFile("../data/alma.png");
  Image i;    i.readFromFile("../data/i.png");
  // Image penguin;    penguin.readFromFile("../data/penguin.png");
  ...
  sheet.addSticker(i, 20, 200);
  sheet.addSticker(i, 60, 200);
  REQUIRE(sheet.setStickerAtLayer(i, 4, 100, 200) == 2);
...
// copy ctor
//
TEST_CASE("StickerSheet's copy constructor makes an independent copy", "[weight=2][part=2][valgrind][timeout=45000]") {
  Image alma; alma.readFromFile("../data/alma.png");
  Image i;    i.readFromFile("../data/i.png");
  Image expected; expected.readFromFile("../data/expected.png");
  Image expected2; expected2.readFromFile("../data/expected-2.png");

  StickerSheet s1(alma);
...
TEST_CASE("StickerSheet's assignment operator makes an independent copy", "[weight=2][part=2][valgrind][timeout=45000]") {
  Image alma; alma.readFromFile("../data/alma.png");
  Image i;    i.readFromFile("../data/i.png");
  Image expected; expected.readFromFile("../data/expected.png");
  Image expected2; expected2.readFromFile("../data/expected-2.png");
